        ...
        <div className="container">
          ...
          <StaggerContainer className="features-grid">
            {[
              ...
              <StaggerItem key={i} whileHover={{ y: -8, scale: 1.02 }}>
        ...
        <div className="container">
          ...
          <StaggerContainer className="categories-grid">
            {categoriesStats.map((cat: any) => (
              <StaggerItem key={cat.id} whileHover={{ y: -8, scale: 1.03 }}>
                <Link href={`/books/categories/${cat.id}`} className="category-card" style={{ height: "100%", display: "flex", flexDirection: "column", justifyContent: "center" }}>
